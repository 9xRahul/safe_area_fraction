...
## 🪄 Upcoming (Planned)
### 🚧 Roadmap
- [ ] Add `SafeFractionBuilder` widget for dynamic layout adjustments.
- [ ] Add animated safe padding transitions.
- [ ] Add adaptive layout helpers for foldable devices.
- [ ] Provide more utility extensions for safe margin/positioning.

---

### 💬 Notes
- If you find bugs or have feature suggestions, open an issue at:  
  👉 [https://github.com/9xRahul/safe_area_fraction/issues](https://github.com/9xRahul/safe_area_fraction/issues)

---

### ❤️ Maintained by
**Rahul** — passionate Flutter developer building utility-first packages.
